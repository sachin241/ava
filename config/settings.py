...
PATH_LEFT_RATIO = float(os.getenv("PATH_LEFT_RATIO", "0.36"))
PATH_RIGHT_RATIO = float(os.getenv("PATH_RIGHT_RATIO", "0.64"))
PATH_MIN_OVERLAP_RATIO = float(os.getenv("PATH_MIN_OVERLAP_RATIO", "0.45"))
SAFETY_MIN_CONFIDENCE = float(os.getenv("SAFETY_MIN_CONFIDENCE", "0.55"))
SAFETY_BLOCK_CONFIRM_FRAMES = int(os.getenv("SAFETY_BLOCK_CONFIRM_FRAMES", "2"))
SAFETY_CLEAR_CONFIRM_FRAMES = int(os.getenv("SAFETY_CLEAR_CONFIRM_FRAMES", "2"))
