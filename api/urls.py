...
from .views import command, complete_response, currency, detect, emergency, health, read, repeat_response, stop_response, transcribe
...
urlpatterns = [
    ...
    path("interaction/currency/", currency, name="currency"),
